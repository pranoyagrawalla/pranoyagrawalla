    ...
    <div>
      <div className={styles.___main__footer__}>
        <div className={styles.__footer__main__content__}>
          ...
          <p>
            Bugslayhub is a leading rental company with a pan-India presence. We
          ...
          <p>
            Bugslayhub makes it effortless for you to rent from us. All you need
            ...
            <div>
              ...
              >
                ...
                <div className={styles.__mail_rento__}>
                  ...
                  >
                    <IoIosPaperPlane /> rento@bugslayhub.com
                  </a>
                </div>
                <h3>DOWNLOAD APP</h3>
